...
def filter_by_region(ti):
    ...
    region_df.to_csv('/Users/loonycorn/airflow/output/filtered_by_region.csv', index=False)
...
def filter_bmi_smoker_charges(ti):
    ...
    selected_cols_df.to_csv('/Users/loonycorn/airflow/output/selected_cols.csv', index=False)
...
def groupby_region_smoker(ti):
    ...
    region_df.to_csv('/Users/loonycorn/airflow/output/grouped_by_region.csv', index=False)
    ...
    smoker_df.to_csv('/Users/loonycorn/airflow/output/grouped_by_smoker.csv', index=False)
